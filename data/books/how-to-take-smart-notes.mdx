...
Ahrens sings the praises of the slip box (or “zettlekasten”, as Luhmann called it). And much of the book is about how to use a zettlekasten as your second brain.

However, it’s now 2020, and each year (month?), we get better tools. I use Roam, but I also recommend Obsidian. Others love Notion, which is a fine choice as well. (Especially considering the introduction of backlinking and the fundamental fact that Notion is built on blocks, so block level references should be possible).
...
This is liberating to hear, but for many of us, we’ve got to be skeptical of this statement. This attitude of only working on stuff when you feel like it is shared by the least productive people as well. So what else must we do?

Ahrens provides a crystal clear direction: “work as if nothing else counts than writing”. In other words, when it comes to learning, you must write:
...
This is where I believe the vast majority of people go wrong. This is not a simple transcription process, - it’is a game.
...
The work during this step, of filtering, transforming, and enriching fleeting notes into your zettlekasten, is what Ahrens calls making “permanent notes”. There’s definitely an art to it, but as Ahrens describes:
...
Am I an expert on grwoth and enabling environments now? Absolutely not, but I’m certainly more thoughtful than if I had just hit the “like” button on Twitter.
...
However, my favorite part of the book had little to do with this core argument. Ahrens has a terrific quote about salvaging interesting tidbits from the book: “We constantly encounter interesting ideas along the way and only a fraction of them are useful for the particular paper we started reading it for. Why let them go to waste?”

With that in mind, here’s a bonus section - a list of interesting morsels I captured from the book, which you might wish to chew on as food for thought.
